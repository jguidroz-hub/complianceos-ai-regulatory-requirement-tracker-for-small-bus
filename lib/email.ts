...
const FROM = process.env.EMAIL_FROM || 'ComplianceOS - AI regulatory requirement tracker for small business tax and compliance <noreply@example.com>';
const APP_NAME = 'ComplianceOS - AI regulatory requirement tracker for small business tax and compliance';

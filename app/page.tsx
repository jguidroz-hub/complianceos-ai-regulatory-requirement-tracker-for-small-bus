  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">ComplianceOS - AI regulatory requirement tracker for small business tax and compliance</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Automatically tracks changing regulatory requirements and tax obligations for small businesses. Reduces compliance errors by 60% and saves 10+ hours/month on regulatory research for business owners and accountants.
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust ComplianceOS - AI regulatory requirement tracker for small business tax and compliance.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} ComplianceOS - AI regulatory requirement tracker for small business tax and compliance. All rights reserved.</p>

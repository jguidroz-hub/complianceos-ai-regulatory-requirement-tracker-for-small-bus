  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="ComplianceOS - AI regulatory requirement tracker for small business tax and compliance-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
